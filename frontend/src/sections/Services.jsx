...
const plans = [
  {
    name: 'Free Trial',
    price: '$0',
    description: 'Try Reserva.ai free for 7 days — no commitment, all features unlocked!',
    features: [
        "Full access to AI booking assistant",
        "Unlimited reservation management",
        "Multi-language support (Arabic, French, English)",
        "Voice message handling for bookings",
    ...
    btnClass: 'ring-1 ring-slate-700 text-white hover:ring-slate-500',
  },
  {
    name: 'Recommended',
    price: '$15',
  ...
  },
  {
    ...
    features: [
        ...
        "Unlimited AI agent customizations",
